    ...
    wrap.onclick = function(e) {
        ...
        if (type == "one") {
            if (target.checked) {
                ...
                history.pushState(c2e[id], null, "#"+c2e[id])
                var num = 0;
                //因为是操作最后一个，不计算最后一个
                ...
                history.replaceState(c2e[id], null, null);
                var num = 0;
                //判断最后一个，所以计算全部
                ...
                if (0 == num) {
                    ...
                    history.replaceState(c2e[allId], null, null);
                }
            }
        } else if (type == "all") {
            if (target.checked) {
                ...
                for (var i=0; i<length-1; i++) {
                    ...
                    history.pushState(c2e[oneId], null, "#"+c2e[oneId]);
                    // var oldValue = window.location.hash;
